...
namespace DTR.TicketEvolution
{
    public class TicketAPI
    {
        ...
        public TicketAPI()
        {
            try
            {
                token = System.Configuration.ConfigurationManager.AppSettings["TE_Token"].ToString();
                secret = System.Configuration.ConfigurationManager.AppSettings["TE_Secret"].ToString();
            }
            catch (Exception e) {
                token = "";
                secret = "";
            }
            address = "api.ticketevolution.com/";
        }

        public TicketAPI(string t, string s, bool test)
        {
            token = t;
            secret = s;
            if (test == true)
                address = "api.sandbox.ticketevolution.com/";
            else
                address = "api.ticketevolution.com/";
        }

        //convert a ticketapi() call to test mode if you have web config
        public void TestMode()
        {
            try
            {
                token = System.Configuration.ConfigurationManager.AppSettings["TE_Token_Sandbox"].ToString();
                secret = System.Configuration.ConfigurationManager.AppSettings["TE_Secret_Sandbox"].ToString();
            }
            catch (Exception e) {
                secret = "";
                token = "";
        ...
        public List<Brokerage> GetAllBrokerages()
        {
            ...
            catch (Exception e) { return new List<Brokerage>(); }
        }
        ...
        public List<TicketGroup> GetEventTicketGroups(int event_id)
        {
            ...
            catch (Exception e) { return new List<TicketGroup>(); }
        }
        ...
        public TicketGroup GetTicketGroup(int ticketgroupid)
        {
            ...
            catch (Exception e) { return new TicketGroup(); }
        }
        ...
        public List<Event> GetEvents()
        {
            try
            {
                string Response = GetAPIResponse("events?per_page=100?page=1");
            ...
            catch (Exception e) { return new List<Event>(); }
        }
        ...
        public List<Office> GetOffices()
        {
            try
            {
                string Response = GetAPIResponse("offices?per_page=100?page=1");
            ...
            catch (Exception e) { return new List<Office>(); }
        }

        public List<User> GetUsersByOfficeId()
        {
            try
            {
                string Response = GetAPIResponse("users?office_id=53");
            ...
            catch (Exception e) { return new List<User>(); }
        }

        public List<Office> GetOfficesByBrokerage()
        {
            try
            {
                string Response = GetAPIResponse("offices?brokerage_id=200?per_page=100?page=1");
                JObject OfficeSet = JObject.Parse(Response);
                List<JToken> items = OfficeSet["offices"].Children().ToList();
                List<Office> o = new List<Office>();
                foreach (JToken item in items)
        ...
        public Office GetOfficeByID(int officeid)
        {
            try
            {
                string Response = GetAPIResponse("offices/" + officeid.ToString());
                Office office = JsonConvert.DeserializeObject<Office>(Response);
                return office;
            }
            catch (Exception e) { return new Office(); }
        }

        public List<Account> GetEvoPayAccounts()
        {
            try
            {
                string Response = GetAPIResponse("accounts?per_page=100?page=1");
            ...
            catch (Exception e) { return new List<Account>(); }
        }
        ...
        public Client AddClient(string name, int office_id)
        {
            try
            {
                ...
                temp = temp + "}]}";
                string Response = PostAPIResponse("clients?", temp);
            ...
            catch (Exception e) { return new Client(); }
        }
        ...
        public Client UpdateClient(int id, string name, int office_id)
        {
            try
            {
                ...
                temp = temp.Substring(0, temp.Length - 1);
                temp = temp + "}";
                string Response = PutAPIResponse("clients/" + id.ToString() + "?", temp);
        ...
        public Client GetClient(int id)
        {
            try
            {
                string Response = GetAPIResponse("clients/" + id.ToString());
        ...
        public List<Client> GetAllClients()
        {
            ...
            {
                List<Client> c = new List<Client>();
                string Response = GetAPIResponse("clients?page=1?per_page=1");
                ...
                {
                    Response = GetAPIResponse("clients?per_page=" + per_page.ToString() + "?" + "page=" + (i + 1).ToString());
            ...
            catch (Exception e) { return new List<Client>(); }
        }
        ...
        public List<Client> GetAllClientsByOffice(int office_id)
        {
            ...
            {
                List<Client> c = new List<Client>();
                string Response = GetAPIResponse("clients?office_id=" + office_id.ToString() + "?page=1?per_page=1");
                JObject page = JObject.Parse(Response);
                JToken results = page["total_entries"];
                int total = JsonConvert.DeserializeObject<int>(results.ToString());
                double mytotal = Convert.ToDouble(total);
                ...
                for (double i = 0; i < pages; i++)
                {
                    Response = GetAPIResponse("clients?office_id=" + office_id.ToString() + "?per_page=" + per_page.ToString() + "?" + "page=" + (i + 1).ToString());
                    page = JObject.Parse(Response);
                    List<JToken> items = page["clients"].Children().ToList();
                    foreach (JToken item in items)
                    {
        ...
        public Address AddClientAddress(int id, string name, string company, string street_address, string extended_address, string locality, string region, string postal_code, string country_code, string label)
        {
            try
            {
                ...
                temp = temp.Substring(0, temp.Length - 1);
                temp = temp + "}]}";
                string Response = PostAPIResponse("clients/" + id.ToString() + "/addresses?", temp);
            ...
            catch (Exception e) { return new Address(); }
        }
        ...
        public Address UpdateClientAddress(int clientid, int addressid, string name, string company, string street_address, string extended_address, string locality, string region, string postal_code, string country_code, string label)
        {
            try
            {
                ...
                temp = temp.Substring(0, temp.Length - 1);
                temp = temp + "}";
                string Response = PutAPIResponse("clients/" + clientid.ToString() + "/addresses/" + addressid.ToString() + "?", temp);
        ...
        public Address GetClientAddress(int clientid, int addressid)
        {
            try
            {
                string Response = GetAPIResponse("clients/" + clientid.ToString() + "/addresses/" + addressid.ToString());
                Address a = JsonConvert.DeserializeObject<Address>(Response);
                return a;
            }
            catch (Exception e) { return new Address(); }
        ...
        public List<Address> GetAllClientAddresses(int id) //clientid
        {
            try
            {
                string Response = GetAPIResponse("clients/" + id.ToString() + "/addresses?per_page=1?page=1");
                List<Address> a = new List<Address>();
                JObject page = JObject.Parse(Response);
                JToken results = page["total_entries"];
                int total = JsonConvert.DeserializeObject<int>(results.ToString());
                ...
                for (double i = 0; i < pages; i++)
                {
                    Response = GetAPIResponse("clients/" + id.ToString() + "/addresses?" + "per_page=" + per_page.ToString() + "?" + "page=" + (i + 1).ToString());
                    page = JObject.Parse(Response);
            ...
            catch (Exception e) { return new List<Address>(); }
        }
        ...
        public Email_Address AddClientEmailAddress(int id, string address, string label)
        {
            try
            {
                ...
                temp = temp.Substring(0, temp.Length - 1);
                temp = temp + "}]}";
                string Response = PostAPIResponse("clients/" + id.ToString() + "/email_addresses?", temp);
            ...
            catch (Exception e) { return new Email_Address(); }
        }
        ...
        public Email_Address UpdateClientEmailAddress(int clientid, string address, int emailaddressid, string label)
        {
            try
            {
                ...
                temp = temp.Substring(0, temp.Length - 1);
                temp = temp + "}";
                string Response = PutAPIResponse("clients/" + clientid.ToString() + "/email_addresses/" + emailaddressid.ToString() + "?", temp);
        ...
        public Email_Address GetClientEmailAddress(int clientid, int emailaddressid)
        {
            try
            {
                string Response = GetAPIResponse("clients/" + clientid.ToString() + "/email_addresses/" + emailaddressid.ToString());
                Email_Address ea = JsonConvert.DeserializeObject<Email_Address>(Response);
                return ea;
            }
            catch (Exception e) { return new Email_Address(); }
        ...
        public List<Email_Address> GetAllClientEmailAddresses(int id)
        {
            try
            {
                string Response = GetAPIResponse("clients/" + id.ToString() + "/email_addresses?per_page=1?page=1");
                List<Email_Address> ea = new List<Email_Address>();
                JObject page = JObject.Parse(Response);
                JToken results = page["total_entries"];
                int total = JsonConvert.DeserializeObject<int>(results.ToString());
                ...
                for (double i = 0; i < pages; i++)
                {
                    Response = GetAPIResponse("clients/" + id.ToString() + "/email_addresses?" + "per_page=" + per_page.ToString() + "?" + "page=" + (i + 1).ToString());
                    page = JObject.Parse(Response);
            ...
            catch (Exception e) { return new List<Email_Address>(); }
        }
        ...
        public Phone_Number AddClientPhoneNumber(int id, string number, string country_code, string extension, string label)
        {
            try
            {
                ...
                temp = temp.Substring(0, temp.Length - 1);
                temp = temp + "}]}";
                string Response = PostAPIResponse("clients/" + id.ToString() + "/phone_numbers?", temp);
            ...
            catch (Exception e) { return new Phone_Number(); }
        }
        ...
        public Phone_Number UpdateClientPhoneNumber(int clientid, int phonenumberid, string number, string country_code, string extension, string label)
        {
            try
            {
                ...
                temp = temp.Substring(0, temp.Length - 1);
                temp = temp + "}";
                string Response = PutAPIResponse("clients/" + clientid.ToString() + "/phone_numbers/" + phonenumberid.ToString() + "?", temp);
        ...
        public Phone_Number GetClientPhoneNumber(int clientid, int phonenumberid)
        {
            try
            {
                string Response = GetAPIResponse("clients/" + clientid.ToString() + "/phone_numbers/" + phonenumberid.ToString());
                Phone_Number p = JsonConvert.DeserializeObject<Phone_Number>(Response);
                return p;
            }
            catch (Exception e) { return new Phone_Number(); }
        ...
        public List<Phone_Number> GetAllClientPhoneNumbers(int id)
        {
            try
            {
                string Response = GetAPIResponse("clients/" + id.ToString() + "/phone_numbers?per_page=1?page=1");
                List<Phone_Number> p = new List<Phone_Number>();
                JObject page = JObject.Parse(Response);
                JToken results = page["total_entries"];
                int total = JsonConvert.DeserializeObject<int>(results.ToString());
                ...
                for (double i = 0; i < pages; i++)
                {
                    Response = GetAPIResponse("clients/" + id.ToString() + "/phone_numbers?" + "per_page=" + per_page.ToString() + "?" + "page=" + (i + 1).ToString());
                    page = JObject.Parse(Response);
            ...
            catch (Exception e) { return new List<Phone_Number>(); }
        }
        ...
        public Credit_Card AddClientCreditCard(int clientid, int address_id, int phone_number_id, string number, int verification_code, int expiration_month, int expiration_year, string name, Dictionary<string, string> optional_values)
        {
            try
            {
                ...
                temp = temp.Substring(0, temp.Length - 1);
                temp = temp + "}]}";
                string Response = PostAPIResponse("clients/" + clientid.ToString() + "/credit_cards?", temp);
                Credit_Card c = JsonConvert.DeserializeObject<Credit_Card>(Response);
                return c;
            }
            catch (Exception e) { return new Credit_Card(); }
        }
        ...
        public List<Credit_Card> GetAllClientCreditCards(int id)
        {
            ...
            catch (Exception e) { return new List<Credit_Card>(); }
        }
        ...
        public Order CreateBrokerageOrder(int buyer_id, int ticket_group_id, int quantity, decimal price, string invoice_number, decimal shipping, decimal service_fee, decimal tax, decimal additional_expense, string instructions, string po_number)
        {
            try
            {
                ...
                temp = temp.Substring(0, temp.Length - 1);
                temp = temp + "}]}";
                string Response = PostAPIResponse("orders?", temp);
                Response = Response.Replace("\"event\":", "event_:");
            ...
            catch (Exception e) { return new Order(); }
        }
        ...
        public Order UpdateCustomerOrder(int order_id, string po_number, string invoice_number, string instructions, int billing_address_id, int shipping_address_id)
        {
            try
            {
                ...
                if (temp != "{")
                    temp = temp.Substring(0, temp.Length - 1);
                temp = temp + "}";
                string Response = PutAPIResponse("orders/" + order_id.ToString() + "?", temp);
                Response = Response.Replace("\"event\":", "event_:");
        ...
        public void AcceptOrder(int order_id, int reviewer_id)
        {
            ...
            string Response = PostAPIResponse("orders/" + order_id.ToString() + "/accept",temp);
        }
        ...
        public Order CreateFullfillmentOrder(int buyer_id, int ticket_group_id, int quantity, decimal price, string invoice_number, decimal shipping, decimal service_fee, decimal tax, decimal additional_expense, string instructions, string po_number)
        {
            try
            {
                ...
                temp = temp.Substring(0, temp.Length - 1);
                temp = temp + "}]}";
                string Response = PostAPIResponse("orders/fulfillments?", temp);
                Response = Response.Replace("\"event\":", "event_:");
                JObject OrderSet = JObject.Parse(Response);
                List<JToken> my_items = OrderSet["orders"].Children().ToList();
                List<Order> o = new List<Order>();
        ...
        public void RejectOrder(int order_id, int reviewer_id, bool not_available, bool priced_incorrectly, bool duplicate, bool fraudulent)
        {
            ...
            if(not_available == true)
             ...
             string Response = PostAPIResponse("orders/" + order_id.ToString() + "/reject",temp);
        }

        public void CompleteOrder(int order_id)
        {
            string temp = "{}";
            string Response = PostAPIResponse("orders/" + order_id.ToString() + "/complete",temp);
        }
        ...
        public List<Order> GetAllOrders()
        {
            ...
            catch (Exception e) { return new List<Order>(); }
        }
        ...
        public Shipment AddOrderShipment(int order_id, bool fedex, bool ups, bool courier, string pdf, List<int> items, string tracking_number, string service_type)
        {
            try
            {
                ...
                temp = temp.Substring(0, temp.Length - 1);
                temp = temp + "}]}";
                string Response = PostAPIResponse("shipments?", temp);
                Response = Response.Replace("\"event\":", "event_:");
                JObject OrderSet = JObject.Parse(Response);
            ...
            catch (Exception e) { return new Shipment(); }
        }
        ...
        public Shipment UpdateOrderShipment(int shipment_id, bool update_shipping_type, bool fedex, bool ups, bool courier, string pdf, string tracking_number, string service_type)
        {
            try
            {
                ...
                if (temp != "{")
                    temp = temp.Substring(0, temp.Length - 1);
                temp = temp + "}";
                string Response = PutAPIResponse("shipments/" + shipment_id.ToString() + "?", temp);
                Response = Response.Replace("\"event\":", "event_:");
        ...
        public Shipment GetOrderShipment(int shipment_id)
        {
            try
            {
                string Response = GetAPIResponse("shipments/" + shipment_id.ToString() + "?");
                Response = Response.Replace("\"event\":", "event_:");
        ...
        public List<Shipment> GetAllOrderShipments()
        {
            ...
            catch (Exception e) { return new List<Shipment>(); }
        }
        ...
        public List<Quote> GetAllQuotes()
        {
            try
            {
                string Response = GetAPIResponse("quotes?per_page=1?page=1");
                Response = Response.Replace("\"event\":", "event_:");
                ...
                for (double i = 0; i < pages; i++)
                {
                    Response = GetAPIResponse("quotes?per_page=" + per_page.ToString() + "?" + "page=" + (i + 1).ToString());
                    Response = Response.Replace("\"event\":", "\"event_\":");
                    page = JObject.Parse(Response);
            ...
            catch (Exception e) { return new List<Quote>(); }
        }
        ...
        public Quote GetQuote(int quote_id)
        {
            try
            {
                string Response = GetAPIResponse("quotes/" + quote_id.ToString());
                Response = Response.Replace("\"event\":", "\"event_\":");
                Quote q = JsonConvert.DeserializeObject<Quote>(Response);
                return q;
            }
            catch (Exception e) { return new Quote(); }
        }
        ...
        public List<Quote> SearchQuotes(string s)
        {
            try
            {
                string Response = GetAPIResponse("quotes/search?per_page=1?page=1?q=\"" + s + "\"");
                List<Quote> q = new List<Quote>();
                JObject page = JObject.Parse(Response);
                JToken results = page["total_entries"];
                int total = JsonConvert.DeserializeObject<int>(results.ToString());
                ...
                for (double i = 0; i < pages; i++)
                {
                    Response = GetAPIResponse("quotes/search?per_page=" + per_page.ToString() + "?" + "page=" + (i + 1).ToString()) + "?q=\"" + s + "\"";
                    Response = Response.Replace("\"event\":", "\"event_\":");
                    page = JObject.Parse(Response);
                    List<JToken> items = page["quotes"].Children().ToList();
                    foreach (JToken item in items)
        ...
        public string PutAPIResponse(string url, string body)
        {
            try
            {
                string api = address + url + body;
                ...
                HttpWebRequest request = (HttpWebRequest)WebRequest.Create("https://" + address + url);
                request.Method = "PUT";
        ...
        public string PostAPIResponse(string url, string body)
        {
            try
            {
                string api = address + url + body;
